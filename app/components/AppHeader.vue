  ...
  <div :class="[
    ...
    <div :class="[
      ...
      <NuxtLink to="/" class="flex items-center gap-2 group relative z-10 transition-transform hover:scale-105">
        <img src="/km-software-logo.png" alt="KM Softwares" class="h-12 sm:h-16 w-auto object-contain" />
      </NuxtLink>
          ...
          <div class="dropdown-content z-[100] pt-2">
            <ul tabindex="0"
              ...
              <li v-for="service in services" :key="service.title">
                <NuxtLink :to="service.link" @click="closeDropdown"
                  class="flex items-center gap-3 hover:bg-primary/10 rounded-xl p-3 group transition-all">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="dropdown dropdown-end lg:hidden">
          <div tabindex="0" role="button" class="btn btn-ghost btn-sm btn-circle hover:bg-primary/10">
          ...
          <ul tabindex="0"
            ...
            <li>
              <NuxtLink to="/" @click="closeDropdown" class="rounded-xl hover:bg-primary/10">Home</NuxtLink>
            </li>
            ...
            <li>
              <details>
                ...
                <ul class="p-2 bg-base-200/50 rounded-xl mt-2">
                  <li v-for="service in services" :key="service.title">
                    <NuxtLink :to="service.link" @click="closeDropdown"
                      class="flex items-center gap-2 hover:bg-primary/10 rounded-lg text-sm">
            ...
            <li>
              <NuxtLink to="/about" @click="closeDropdown" class="rounded-xl hover:bg-primary/10">About</NuxtLink>
            </li>
            <li>
              <NuxtLink to="/portfolio" @click="closeDropdown" class="rounded-xl hover:bg-primary/10">Portfolio
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/contact" @click="closeDropdown" class="rounded-xl hover:bg-primary/10">Contact</NuxtLink>
            </li>
          </ul>
        </div>
      </div>
...
const services = [
  ...
  { icon: '📱', title: 'App Development', subtitle: 'iOS & Android', link: '/services/app-development' },
  ...
  { icon: '🤖', title: 'AI & ML', subtitle: 'Intelligent Automation', link: '/services/ai-ml' },
  { icon: '🔒', title: 'Cyber Security', subtitle: 'Advanced Protection', link: '/services/cyber-security' },
  { icon: '☁️', title: 'Cloud & DevOps', subtitle: 'Scalable Infrastructure', link: '/services/cloud-and-devops' },
  { icon: '💡', title: 'IT Consulting', subtitle: 'Strategic Guidance', link: '/services/it-consulting' },
];
