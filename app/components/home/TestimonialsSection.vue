      ...
      <div class="max-w-3xl mx-auto relative">
        ...
        <div class="overflow-hidden rounded-2xl">
          <transition name="slide-fade" mode="out-in">
            <div :key="currentIndex" class="card bg-base-200/60 border border-primary/15 shadow-lg">
              <div class="card-body p-8 sm:p-10 text-center">
                ...
                <blockquote
                  class="text-lg sm:text-xl text-base-content/90 leading-relaxed font-medium italic mb-8 max-w-xl mx-auto">
                ...
                <div class="flex items-center justify-center gap-4">
                  ...
                  <div class="text-left">
                    ...
                    <p class="text-sm text-base-content/60">{{ currentTestimonial.role }}, {{ currentTestimonial.company
                      }}</p>
                  </div>
                </div>
              </div>
        ...
        <div class="flex justify-center items-center gap-2 mt-8">
          <button v-for="(_, i) in testimonials" :key="i" @click="goToSlide(i)"
            class="rounded-full transition-all duration-300" :class="i === currentIndex
              ? 'w-8 h-3 bg-primary'
              : 'w-3 h-3 bg-base-content/20 hover:bg-primary/50'" :aria-label="`Go to testimonial ${i + 1}`"></button>
        </div>
...
const testimonials = ref<Testimonial[]>([
  {
    quote: "KM Softwares transformed our outdated systems into a modern, scalable platform. Their team's expertise and dedication exceeded our expectations.",
    name: "Sarah Johnson",
    role: "CTO",
