  ...
  <div class="min-h-screen bg-base-100 pt-32 pb-24">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
      ...
      <div
        ...
        <h2>6. Service Warranties</h2>
        <p>
          We build robust, scalable architecture but cannot guarantee that all code will be eternally error-free due to
          the shifting nature of technology standards. We typically offer a standard post-launch bug triage duration
          (detailed in your MSA). Extended SLAs and maintenance must be purchased separately.
        </p>

        <h2>7. Contact Information</h2>
        <p>
          Legal inquiries, questions about MSA clauses, and questions regarding this document should be sent directly to
