      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
          ...
          <div v-else-if="posts.length > 0">
            ...
            <div v-if="posts.length > 0" class="mb-16">
              <NuxtLink :to="`/blog/${posts[0].slug}`"
                ...
                <div
                  class="lg:w-1/2 bg-gradient-to-br from-primary/10 via-secondary/5 to-accent/10 min-h-[300px] lg:min-h-full flex justify-center items-center relative overflow-hidden">
                  <img v-if="posts[0].coverImage" :src="posts[0].coverImage" :alt="posts[0].title"
                  ...
                  <div v-else class="text-center p-8 relative z-10">
                    ...
                    <span class="text-base-content/30 font-bold text-lg tracking-widest uppercase">{{ posts[0].category
                      }}</span>
                  </div>
                </div>
                <div class="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <h3 class="text-2xl sm:text-3xl font-bold mb-4 group-hover:text-primary transition-colors">{{
                    posts[0].title }}</h3>
            ...
            <div v-if="posts.length > 1" class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <NuxtLink v-for="post in posts.slice(1)" :key="post.id" :to="`/blog/${post.slug}`"
                ...
                <div
                  class="h-48 bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 flex justify-center items-center relative overflow-hidden">
                ...
                <div class="card-body p-6">
                  <span class="text-xs font-bold uppercase tracking-widest mb-2 block text-primary">{{ post.category
                    }}</span>
                  <h3 class="card-title text-xl font-bold leading-tight group-hover:text-primary transition-colors">{{
                    post.title }}</h3>
          ...
          <div v-else class="text-center py-16">
            ...
            <p class="text-base-content/60 max-w-md mx-auto">We're preparing our first set of articles. Stay tuned for
              valuable tech insights and practical guides.</p>
          </div>
        </div>
      </div>
    </section>
