    ...
    <section class="relative bg-gradient-to-br from-base-100 via-base-200 to-base-100 pb-24 overflow-hidden">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          ...
          <div class="space-y-8">
            <div>
              ...
              <p class="text-base sm:text-lg text-base-content/80 leading-relaxed max-w-lg mb-4">
                Artificial Intelligence is no longer the future — it's the present. Businesses using AI today are
          ...
          <div>
            <img src="/images/ai-illustration.png" alt="">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto">
          ...
          <div class="text-center mb-12">
            ...
            <p class="text-lg text-base-content/70 max-w-2xl mx-auto">
              AI helps businesses stay ahead by transforming operations, improving customer experiences, and unlocking
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            <div v-for="(matter, index) in whyAiMatters" :key="matter"
              class="flex items-start gap-4 p-5 rounded-2xl bg-base-100 border border-base-content/5 hover:border-primary/20 hover:shadow-md transition-all">
          ...
          <div class="text-center">
            <p
              class="inline-block text-base text-primary font-bold italic px-6 py-3 rounded-full bg-primary/5 border border-primary/10">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          <div v-for="(service, index) in services" :key="index"
            ...
            <div
              class="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-base-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            </div>

            <div class="relative z-10 flex flex-col flex-grow">
              <div
                class="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/10 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary/20 transition-all duration-300">
                <component :is="service.icon" class="w-8 h-8 text-primary" />
              </div>

              <h3
                class="text-2xl font-bold mb-4 text-base-content group-hover:text-primary transition-colors duration-300">
                {{ service.title }}</h3>
              ...
              <div
                class="pt-4 border-t border-base-content/10 flex items-center text-sm font-bold text-base-content/60 group-hover:text-primary transition-colors w-full cursor-pointer">
                Explore Solution
                <svg class="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div v-for="(step, index) in processSteps" :key="index" class="relative group">
              <div class="bg-base-200 rounded-2xl p-8 h-full hover:shadow-xl transition-all">
                <div class="flex items-center gap-4 mb-6">
                  <div
                    class="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center font-bold text-primary text-xl">
                    {{ index + 1 }}
                  </div>
      ...
      <div class="container mx-auto px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          <div>
            ...
            <p class="text-lg text-base-content/70 leading-relaxed max-w-lg">
              We build practical AI solutions that solve real business problems.
              Our team focuses on delivering scalable, reliable, and production-ready
          ...
          <div class="grid sm:grid-cols-2 gap-6">
            ...
            <div v-for="reason in whyChooseUs" :key="reason"
              class="flex items-start gap-4 p-6 rounded-xl bg-base-100 border border-base-content/10 hover:shadow-lg transition">

              <div
                class="w-10 h-10 rounded-lg bg-success/20 text-success flex items-center justify-center flex-shrink-0">
                ✓
              </div>
    ...
    <section class="py-24 bg-base-100">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
          ...
          <!-- Dynamic FAQ Items -->
          <div class="space-y-4">
            <div v-for="(faq, index) in faqSection.items" :key="index" :class="faqSection.itemClassName">
              ...
              <div class="collapse-title text-lg sm:text-xl font-bold pr-12 flex items-center gap-3">
                ...
                <svg v-else-if="faqSection.itemIcon" class="w-5 h-5 flex-shrink-0 text-primary" fill="currentColor"
                  viewBox="0 0 20 20">
